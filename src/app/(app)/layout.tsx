    ...
    <div className="flex min-h-screen">
      <aside className="flex w-56 shrink-0 flex-col border-r bg-sidebar px-3 py-5 print:hidden">
        ...
        <div className="mt-auto border-t pt-4">
          {user.role === "admin" && (
            <Link
              href="/ciselniky/sablony"
              className="mb-2 flex w-full items-center justify-start gap-2 rounded-lg bg-violet-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-700"
            >
